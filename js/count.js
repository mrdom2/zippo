...
message04 = '<div class="show-message__item show-message_online"><i class="everad-sprite everad-sprite-callback"></i><p class="show-message__info icon-box horizon"><span class="js-show-name"><span class="js-name"></span></span>, только что совершил(а) покупку на сумму 5600 руб.</p></div>';
